...
import com.github.alexthe666.iceandfire.world.gen.processor.DreadMausoleumProcessor;
...
public class IafProcessors {
    ...
    public static final RegistryObject<StructureProcessorType<DreadMausoleumProcessor>> DREAD_MAUSOLEUM_PROCESSOR = registerProcessor("dread_mausoleum_processor", () -> () -> DreadMausoleumProcessor.CODEC);
