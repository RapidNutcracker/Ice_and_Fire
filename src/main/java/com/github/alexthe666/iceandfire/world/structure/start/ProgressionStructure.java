...
public abstract class ProgressionStructure extends LandmarkStructure implements AdvancementLockedStructure, StructureHints {
    protected static <S extends ProgressionStructure> Products.P5<RecordCodecBuilder.Mu<S>, AdvancementLockConfig, HintConfig, ControlledSpawns.ControlledSpawningConfig, DecorationClearance.DecorationConfig, StructureSettings> progressionCodec(RecordCodecBuilder.Instance<S> instance) {
    ...
    public ProgressionStructure(AdvancementLockConfig advancementLockConfig, HintConfig hintConfig, ControlledSpawns.ControlledSpawningConfig controlledSpawningConfig, DecorationClearance.DecorationConfig decorationConfig, StructureSettings structureSettings) {
