...
public interface StructureHints {
    String BOOK_AUTHOR = IceAndFire.MODID + ".book.author";
    ...
    default Mob createHintMonster(Level world) {
        return IafEntityRegistry.PIXIE.get().create(world);
    }
